...
import com.example.admin.mDB.DBTamTru;
...
public class lvSinhVienAdapter extends ArrayAdapter<DBTamTru> {
    private Context context;
    private int resource;
    private List<DBTamTru> arrSinhvien;
    DatabaseReference mData;

    public lvSinhVienAdapter(Context context, int resource, ArrayList<DBTamTru> arrSinhvien) {
...
//        viewHolder.tvAvatar = (TextView) convertView.findViewById(R.id.tvAvatarCT);
        ...
        DBTamTru dbsinhvien = arrSinhvien.get(position);
